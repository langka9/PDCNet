...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--model', type=str, default='pspflow', help='name of the model type. [pluralistic]')
        ...
        parser.add_argument('--is_PID', action='store_true',help='if true, takes images serial')
        parser.add_argument("--KL_Loss", default=200.0, type=float, help="expected KL loss")
        parser.add_argument('--no_affine', action='store_true',help='if true, use additive coupling rather than affine coupling.')

        # data pattern define
        parser.add_argument('--img_file', type=str, default='/data/dataset/train', help='training and testing dataset')
        parser.add_argument('--check', action='store_true',help='if true, check every image of the dataset.')
        ...
        parser.add_argument('--n_bits', type=int, default=5, help='the number of bits')
    ...
    def gather_options(self):
        ...
        model_option_set = networks.get_option_setter(opt.model)
